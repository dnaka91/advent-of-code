...
//! **generate an electromagnetic radiation shield when powered**. Unfortunately, they can **only**
...
//! procedure and keep chips connected to their corresponding RTG when they're in the same room, and
...
//! could be taken:
//!
//! - Bring the Hydrogen-compatible Microchip to the second floor, which is safe because it can get
//!   power from the Hydrogen Generator:
//!
//! ```txt
//! F4 .  .  .  .  .
//! F3 .  .  .  LG .
...
//! ```
//!
//! - Leave the Hydrogen Generator on floor three, but bring the Hydrogen-compatible Microchip back
...
//!   one so you can still use the elevator; this is safe because although the Lithium Generator is
//!   on the destination floor, you can connect Hydrogen-compatible microchip to the Hydrogen
//!   Generator there:
//!
//! ```txt
//! F4 .  .  .  .  LM
