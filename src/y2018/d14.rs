...
//! `1` and the second with score `0`. If the current recipes' scores were `2` and `3`, the sum,
...
//!   recipes **after** the first nine on the scoreboard would be `5158916779` (highlighted in the
