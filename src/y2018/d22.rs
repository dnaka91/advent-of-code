...
//! can see is coming from a small cottage in the distance. You make your way there and knock on the
//! door.
//!
...
//! and he's not sure where he is. Scanning the region briefly, you discover one life signal in a
//! cave system nearby; his friend must have taken shelter there. The man asks if you can go there
...
//!
//! - At `0,0`, the geologic index is `0`. The erosion level is `(0 + 510) % 20183 = 510`. The type
//!   is `510 % 3 = 0`, **rocky**.
...
//!   (`17317`), `8415 * 17317 = 145722555`. The erosion level is
//!   `(145722555 + 510) % 20183 = 1805`. The type is `1805 % 3 = 2`, **narrow**.
//! - At `10,10`, because they are the target's coordinates, the geologic index is `0`. The erosion
//!   level is `(0 + 510) % 20183 = 510`. The type is `510 % 3 = 0`, **rocky**.
//!
