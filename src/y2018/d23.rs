...
//! **less than or equal to** its signal radius (as measured by [Manhattan distance]). Coordinates a
//! distance away of less than or equal to a nanobot's signal radius are said to be **in range** of
//! that nanobot.
//!
...
//! largest. Using that nanobot's location and signal radius, the following nanobots are in or out
//! of range:
//!
...
//! radius.
//!
//! Find the nanobot with the largest signal radius. **How many nanobots are in range** of its
//! signals?
//!
