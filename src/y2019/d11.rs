...
//! outputs `1` (paint white) and then `0` (turn left). After taking these actions and moving
...
//! instructions should be provided `1`. After several more outputs (`0,1`, `1,0`, `1,0`), the area
//! looks like this:
//!
//! ```txt
//! .....
