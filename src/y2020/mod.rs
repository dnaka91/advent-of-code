...
//! <span class="">                  <span class="calendar-color-a">\</span> <span class="calendar-color-b">~</span>                       ..'' </span>
//! <span class="">                   <span class="calendar-color-a">\</span>                     :''  , ^</span>
//! <span class="">                   <span class="calendar-color-b">~</span><span class="calendar-color-a">\</span>                    '. ,    </span>
//! <span class="">                     <span class="calendar-color-a">\</span> <span class="calendar-color-b">~</span>                  :  , ^ </span>
...
//! <span class="calendar-day14">                       <span class="calendar-color-a">\</span>   <span class="calendar-color-g">.</span>       ~   '<span class="calendar-color-g">.</span>    , ^   <span class="calendar-day">14</span></span>
//! <span class="">                     <span class="calendar-color-b">~</span>  <span class="calendar-color-a">\</span><span class="calendar-color-g">'',:</span>  ~         '.<span class="calendar-color-g">.</span>  , ^</span>
//! <a href="d11/index.html" class="calendar-day11 calendar-verycomplete">                       <span class="calendar-color-g">:</span><span class="calendar-color-a">[]</span><span class="calendar-color-g">..'</span>           ~   ''<span class="calendar-color-g">.</span>.<span class="calendar-color-g">.</span>  <span class="calendar-day">11</span> <span class="calendar-mark-complete">*</span><span class="calendar-mark-verycomplete">*</span></a>
//! <a class="calendar-day13">                        <span class="calendar-color-g">''</span><span class="calendar-color-a">\__</span>  <span class="calendar-color-b">~</span>     <span class="calendar-color-a">/</span>             <span class="calendar-day">13</span> <span class="calendar-mark-complete">*</span><span class="calendar-mark-verycomplete">*</span></a>
//! <span class="">                          <span class="calendar-color-b">~</span>  <span class="calendar-color-a">\__</span>    <span class="calendar-color-a">/</span><span class="calendar-color-b">~</span>      ~    </span>
