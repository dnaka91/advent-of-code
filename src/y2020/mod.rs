...
//! <span class=""> <span class="calendar-color-b">~</span>   <span class="calendar-color-b">~</span>      <span class="calendar-color-b">~</span>   <span class="calendar-color-a">\</span>  <span class="calendar-color-b">~</span>                   ~      ~  </span>
//! <a href="d09/index.html" class="calendar-day9 calendar-verycomplete">               <span class="calendar-color-b">~</span> <span class="calendar-color-a">\</span>                 ~       ~    <span class="calendar-color-g">.</span>  <span class="calendar-day"> 9</span> <span class="calendar-mark-complete">*</span><span class="calendar-mark-verycomplete">*</span></a>
//! <span class="">                  <span class="calendar-color-a">\</span> <span class="calendar-color-b">~</span>         .       ~  ~  <span class="calendar-color-g">..''</span> </span>
//! <span class="">                   <span class="calendar-color-a">\</span>             ~       <span class="calendar-color-g">:''</span>  <span class="calendar-color-g">,</span> <span class="calendar-color-w">^</span></span>
//! <span class="calendar-day15">                   <span class="calendar-color-b">~</span><span class="calendar-color-a">\</span>     . '      <span class="calendar-color-a">____</span>~ <span class="calendar-color-g">'.</span> <span class="calendar-color-g">,</span>      <span class="calendar-day">15</span></span>
//! <span class="">                     <span class="calendar-color-a">\</span> <span class="calendar-color-b">~</span>       ~   ~   <span class="calendar-color-a">\</span>  <span class="calendar-color-g">:</span>  <span class="calendar-color-g">,</span> <span class="calendar-color-w">^</span> </span>
