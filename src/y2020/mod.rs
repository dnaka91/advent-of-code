...
//! <span class="">                   <span class="calendar-color-a">\</span>                     :'<span class="calendar-color-g">'</span>  , <span class="calendar-color-w">^</span></span>
//! <span class="">                   <span class="calendar-color-b">~</span><span class="calendar-color-a">\</span>                    '<span class="calendar-color-g">.</span> ,    </span>
//! <span class="">                     <span class="calendar-color-a">\</span> <span class="calendar-color-b">~</span>                  <span class="calendar-color-g">:</span>  <span class="calendar-color-g">,</span> <span class="calendar-color-w">^</span> </span>
//! <a href="d10/index.html" class="calendar-day10 calendar-verycomplete">                   <span class="calendar-color-b">~</span>  <span class="calendar-color-a">\</span>   <span class="calendar-color-b">~</span>            <span class="calendar-color-g">.''</span> ,  ^ ^  <span class="calendar-day">10</span> <span class="calendar-mark-complete">*</span><span class="calendar-mark-verycomplete">*</span></a>
//! <span class="calendar-day14">                       <span class="calendar-color-a">\</span>   <span class="calendar-color-g">.</span>       <span class="calendar-color-b">~</span>   <span class="calendar-color-g">'.</span><span class="calendar-color-a">[]</span>  <span class="calendar-color-g">,</span> <span class="calendar-color-w">^</span>   <span class="calendar-day">14</span></span>
//! <span class="">                     <span class="calendar-color-b">~</span>  <span class="calendar-color-a">\</span><span class="calendar-color-g">'',:</span>  <span class="calendar-color-b">~</span>       <span class="calendar-color-a">_/</span><span class="calendar-color-g">'..</span>  , ^</span>
