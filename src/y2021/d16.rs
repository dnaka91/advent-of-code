...
//! binary number. To do this, the binary number is padded with leading zeroes until its length is a
...
//!   `10`.
//! - The 16 bits labeled `B` contain the second sub-packet, a literal value representing the number
//!   `20`.
//!
...
//! - The 11 bits labeled `A` contain the first sub-packet, a literal value representing the number
//!   `1`.
//! - The 11 bits labeled `B` contain the second sub-packet, a literal value representing the number
//!   `2`.
