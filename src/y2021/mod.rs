...
//! <span class="calendar-day9">         . .' .  <span class="calendar-color-w9"> .      </span> <span class="calendar-color-g">:'..</span>  ..    '            <span class="calendar-day"> 9</span></span>
//! <span class="calendar-day10">                     <span class="calendar-color-w10"> .~ </span> <span class="calendar-color-g">:</span>   ''  ''''             <span class="calendar-day">10</span></span>
