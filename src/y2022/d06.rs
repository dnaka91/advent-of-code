...
//! detected?**
//!
//! [significant]: crate::y2016::d06
//! [experience]: crate::y2016::d25
//! [dealing]: crate::y2019::d07
//! [with]: crate::y2019::d09
//! [signal-based]: crate::y2019::d16
//! [systems]: crate::y2021::d25
//!
//! ## Part Two
//!
...
pub fn solve_part_one(input: &str) -> Result<usize> {
    find_marker(input, 4).context("no packet marker found")
}

pub fn solve_part_two(input: &str) -> Result<usize> {
    find_marker(input, 14).context("no message marker found")
}
...
mod tests {
    ...
    #[test]
    fn part_one() {
        for (input, expect) in INPUTS.iter().zip([7, 5, 6, 10, 11]) {
            assert_eq!(expect, solve_part_one(input).unwrap());
        }
    }

    #[test]
    fn part_two() {
        for (input, expect) in INPUTS.iter().zip([19, 23, 23, 29, 26]) {
